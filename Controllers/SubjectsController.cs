...
//1-да 2-да,но не се използват 3- не разбрах ама май е така мисля че разбрах защо е аз си кръстих проекта BeReadtFor exam по погрешка след това го преименувах на BeReadyForExam и явно съм го изпуснял някуде понеже го направих ръчно
